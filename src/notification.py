...
class NotificationChannel(Enum):
    ...
    SERVERCHAN = "serverchan"  # Server酱（官方 SDK，自动适配 Turbo/3）
...
class NotificationService(
    ...
    def __init__(self, source_message: Optional[BotMessage] = None):
        ...
        ServerchanSender.__init__(self, config)
    ...
    def detect_configured_channels(config: Config) -> List[NotificationChannel]:
        ...
        if getattr(config, "serverchan_sendkey", None):
    ...
    def _send_to_static_channel(
        ...
        *,
        ...
        if channel == NotificationChannel.SERVERCHAN:
            return self.send_to_serverchan(content)
