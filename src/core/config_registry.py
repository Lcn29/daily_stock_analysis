...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    # ------------------------------------------------------------------
    "SERVERCHAN_SENDKEY": {
        "title": "ServerChan SendKey",
        "description": "Server酱 SendKey for official SDK push notifications.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "SERVERCHAN_TAGS": {
        "title": "ServerChan Tags",
        "description": "Server酱标签，多个标签使用竖线分隔。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SERVERCHAN_SHORT": {
        "title": "ServerChan Short",
        "description": "Server酱消息卡片摘要。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SERVERCHAN_CHANNEL": {
        "title": "ServerChan Channel",
        "description": "Server酱 Turbo 消息通道，多个通道使用竖线分隔。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SERVERCHAN_OPENID": {
        "title": "ServerChan OpenID",
        "description": "Server酱 Turbo 抄送 openid，多个用逗号或竖线分隔。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": True,
    ...
    "SERVERCHAN_NOIP": {
        "title": "ServerChan No IP",
        "description": "Server酱 Turbo 是否隐藏调用 IP。",
        "category": "notification",
        "data_type": "bool",
        "ui_control": "switch",
        "is_sensitive": False,
