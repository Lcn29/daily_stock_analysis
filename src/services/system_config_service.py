...
class SystemConfigService:
    ...
    _NOTIFICATION_TEST_KEY_MAP: Dict[str, Tuple[str, str]] = {
        ...
        "SERVERCHAN_SENDKEY": ("serverchan_sendkey", "string"),
        "SERVERCHAN_TAGS": ("serverchan_tags", "string"),
        "SERVERCHAN_SHORT": ("serverchan_short", "string"),
        "SERVERCHAN_CHANNEL": ("serverchan_channel", "string"),
        "SERVERCHAN_OPENID": ("serverchan_openid", "string"),
        "SERVERCHAN_NOIP": ("serverchan_noip", "bool"),
    ...
    def _dispatch_notification_test(
        ...
        *,
        ...
        dispatch = {
            ...
            "serverchan": lambda: ServerchanSender(config).send_to_serverchan(content, title=title, timeout_seconds=timeout_seconds),
